...
var List = React11.forwardRef(function List2(inProps, ref) {
  const props = useDefaultProps({
    props: inProps,
    name: "MuiList"
  });
  ...
  return (0, import_jsx_runtime10.jsx)(ListContext_default.Provider, {
    value: context,
    children: (0, import_jsx_runtime10.jsxs)(ListRoot, {
      as: component,
      className: clsx_default(classes.root, className),
      ref,
      ownerState,
...
var MenuList = React12.forwardRef(function MenuList2(props, ref) {
  ...
  return (0, import_jsx_runtime11.jsx)(List_default, {
    role: "menu",
    ref: handleRef,
    className,
...
var Grow = React13.forwardRef(function Grow2(props, ref) {
  ...
  return (0, import_jsx_runtime12.jsx)(TransitionComponent, {
    appear,
    in: inProp,
    nodeRef,
    onEnter: handleEnter,
...
var Portal = React15.forwardRef(function Portal2(props, forwardedRef) {
  ...
  if (disablePortal) {
    if (React15.isValidElement(children)) {
      ...
      return React15.cloneElement(children, newProps);
    }
  ...
  return (0, import_jsx_runtime17.jsx)(Portal_default, {
    ...
    children: (0, import_jsx_runtime17.jsxs)(RootSlot, {
      ...
      children: [!hideBackdrop && BackdropComponent ? (0, import_jsx_runtime17.jsx)(BackdropSlot, {
        ...
        open,
        children: React19.cloneElement(children, childProps)
      })]
    })
  });
});
...
var SelectInput = React24.forwardRef(function SelectInput2(props, ref) {
  ...
  return (0, import_jsx_runtime22.jsxs)(React24.Fragment, {
